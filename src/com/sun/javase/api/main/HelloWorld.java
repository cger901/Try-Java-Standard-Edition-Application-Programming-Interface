 ...
 */
package com.sun.javase.api.main;
...
public class HelloWorld {
	 ...
	 * 若不包含static修饰符的字段或方法则代表其本身为动态的，动态的字段或方法不能被直接调用，必须先创建实例。 
	 * <p>
	 * “void”是方法的返回类型，void表示该方法没有返回参数。方法的返回的数据类型可以是基本数据类型也可以是引用数据类型。
	 * <p>
	 ...
	 * </li><li>
	 * 接口类中的方法和属性不要加任何修饰符号 （public 也不要加 ） ，保持代码的简洁性，并加上有效的 Javadoc注释。尽量不要在接
